...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  LinkItems = [
    { name: "Papers", icon: FiStar },
    { name: "Discussion_Forum", icon: FiStar },
    { name: "UploadTests", icon: FiSettings },
  ...
  return (
    ...
    >
      <Flex h="20" alignItems="center" mx="8" justifyContent="space-between">
        <img src="/rutgers.png" style={{ width: "45px" }}></img>
